...
\ModifyPageStyle{myheadings}{
  ...
  odd_running_head      = {_chapter}      , % 柱に章内容を出力
  even_running_head     = {_section}      , % 柱に章内容を出力
  %mark_format           = {
  %  _section            = {其\thesection} ,
  %  _chapter            = {第\thechapter} ,
  %}                                       ,
}
